...
| M03 | Why analytical items miss financial accounts | Missing GL root cause | MM-UAT-010, HISTORICAL_AAL_ROOT_CAUSE.md | Legacy 29–59 + synthetic `MM-UAT-TS-2026-04-*` | Classifier distinguishes causes | PASS | HISTORICAL_AAL_ROOT_CAUSE.md |
